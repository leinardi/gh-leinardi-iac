...
MK_COMMON_FILES       := help.mk pre-commit.mk opentofu.mk password.mk

# Repo-local snippets that are NOT in make-common
MK_LOCAL_FILES        := login.mk
...
TF_DIR ?= $(REPO_ROOT)/stacks/github-repos

# Use Cloudflare R2 AWS profile for all tofu targets
AWS_PROFILE ?= r2-gh-leinardi-iac
export AWS_PROFILE
