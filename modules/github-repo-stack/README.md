...
| <a name="input_default_branch_bypass_actors"></a> [default\_branch\_bypass\_actors](#input\_default\_branch\_bypass\_actors) | n/a | <pre>list(object({<br/>    actor_id    = number<br/>    actor_type  = string<br/>    bypass_mode = string<br/>  }))</pre> | <pre>[<br/>  {<br/>    "actor_id": 5,<br/>    "actor_type": "RepositoryRole",<br/>    "bypass_mode": "pull_request"<br/>  }<br/>]</pre> | no |
